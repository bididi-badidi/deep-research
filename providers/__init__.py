    ...
    if backend == Backend.API:
        if name == "anthropic":
            ...
            async def wrapped_anthropic_run(**kwargs):
                ...
                valid_keys = {"model", "system", "messages", "tools", "tool_executor", "max_tokens", "client"}
            ...
            async def wrapped_gemini_run(**kwargs):
                ...
                if kwargs.get("messages"):
                    ...
                    for msg in kwargs["messages"]:
                        ...
                        if isinstance(content, list):
                                ...
                                if item.get("type") == "tool_result":
                                    ...
                                    parts.append(genai_types.Part(
                                        function_response=genai_types.FunctionResponse(
                                            name=item["tool_use_id"].split(":")[0], # simple fallback
                            ...
                            api_messages.append(genai_types.Content(role=role, parts=parts))
                        else:
                ...
                valid_keys = {"model", "system", "prompt", "messages", "tools", "tool_executor", "include_search"}
                filtered_kwargs = {k: v for k, v in kwargs.items() if k in valid_keys}
